  ...
  <div class="h-full flex flex-col">
    <div class="mb-4">
      ...
      <div class="flex items-center justify-between mt-2">
        ...
        >{{ hostname }}</a>
        <svg class="h-6 w-6 fill-current text-gray-300 cursor-pointer" viewBox="0 0 20 20" @click="openUrl">
          <path
      ...
      <svg width="49" height="87" class="mb-3">
        ...
        <defs>
          <radialGradient
            ...
            gradientTransform="matrix(-5.38592 0 0 -5.58557 31.656 34.345)"
          >
          ...
          <radialGradient
            ...
            r="1"
            gradientUnits="userSpaceOnUse"
            gradientTransform="matrix(-5.38593 0 0 -5.58557 16.954 34.345)"
          >
            <stop offset=".13" stop-color="#4974B9" />
            <stop offset="1" stop-color="#020203" />
          </radialGradient>
