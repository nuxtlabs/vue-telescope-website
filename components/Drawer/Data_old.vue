<template>
  <div class="h-full flex flex-col">
    <img
      ...
      class="rounded-lg w-full h-60 object-cover object-top"
    />
    <div class="flex flex-col h-full w-full mt-2 bg-blue-100">
      <div class="text-md text-center">{{ data.domain }}</div>
      <div
        class="bg-gray-100 h-full m-auto shadow-inner rounded overflow-y-scroll mx-4 mb-4"
      >
        <div class="grid grid-cols-2 h-full w-full ml-8 text-sm">
          <div
    ...
    <footer class="flex fixed w-30 mb-4 bottom-0">
      <div class="flex items-center justify-center w-1/5">
        <svg width="49" height="87">
      ...
      <div
        class="flex flex-col content-center items-center justify-center h-full w-full"
      >
