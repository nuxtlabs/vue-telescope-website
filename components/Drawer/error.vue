<template>
  <div class="rounded-lg bg-gray-100 w-full h-full flex">
    ...
    <div class="flex justify-end items-end justify-end mr-4 mb-4 self-end">
      <svg v-if="codeError === '1'" width="156" height="144">
        ...
        <defs>
          ...
          <radialGradient
            ...
            r="1"
            gradientUnits="userSpaceOnUse"
            gradientTransform="matrix(7.61493 0 0 8.1207 74.242 69.254)"
          >
          ...
          <radialGradient
            ...
            r="1"
            gradientUnits="userSpaceOnUse"
            gradientTransform="matrix(7.61493 0 0 8.1207 95.029 69.254)"
          >
            <stop offset=".13" stop-color="#414042" />
            <stop offset="1" stop-color="#020203" />
          </radialGradient>
      ...
      <svg v-else width="156" height="147" fill="none">
        <g opacity=".9">
          <path
            opacity=".9"
