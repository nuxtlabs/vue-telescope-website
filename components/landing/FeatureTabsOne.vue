...
onMounted(() => {
  ...
  // SVG
  timeline([
    [fingerprintRef.value, draw(1), { duration: 0.75, delay: 0.5, easing: [1, 0.5, 1, 0] }],
    [fingerprintRef.value, { fill: props.onSurfaceColor }, { duration: 0.25, easing: 'linear', at: '-0.25' }]
  ])
...
function leave () {
  return new Promise<void>((resolve) => {
    try {
      ...
      // Text
      animate(headlineRef.value, { opacity: 0, filter: 'blur(20px)' }, { duration: 0.5, easing: 'ease-in' })
