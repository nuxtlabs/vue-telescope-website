  ...
  >
    <noscript inline-template>
      <img
        ...
        }c_fill,f_auto,g_north/vue-telemetry/${cloudinaryId}`"
        :alt="alt"
      />
    </noscript>
    <img
