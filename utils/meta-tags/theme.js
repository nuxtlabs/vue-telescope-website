export default ({ primaryColor, secondaryColor, themeColor }) => {
  return [
    ...
    { name: 'msapplication-navbutton-color', content: primaryColor }, // theme-color for Windows Phones and IE11 on Windows 10
    { name: 'msapplication-TileColor', content: secondaryColor },
    // {
